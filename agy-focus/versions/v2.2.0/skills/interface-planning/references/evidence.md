...
- [Android Developers: Material 3 in Compose](https://developer.android.com/develop/ui/compose/designsystems/material3): typography·shape·color를 의미 있는 테마 역할로 관리하며, shape는 주의를 모으고 상태·브랜드를 설명할 때 선택합니다.
