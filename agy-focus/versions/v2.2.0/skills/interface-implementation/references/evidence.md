...
- [Android Developers: Material 3 in Compose](https://developer.android.com/develop/ui/compose/designsystems/material3): typography·shape·color를 의미 역할로 관리하고, 형태는 주의·상태·브랜드를 설명할 때 선택합니다.
