...
SECTION_PATTERNS = {
    "design-plan.md": ("goal|목표", "user|사용자", "task|행동|작업", "content hierarchy|정보 위계|콘텐츠 위계|information architecture|구조", "route|page|경로|페이지", "loading|empty|error|success|disabled|selected|상태", "responsive|mobile|320|반응형|모바일", "motion|animation|애니메이션|움직임", "purpose|목적|이유", "duration|easing|ms|시간|속도", "reduced motion|prefers-reduced-motion|감속", "accessib|접근성|focus|키보드", "evidence|근거|source|출처|https?://"),
    ...
    "verification-plan.md": ("command|명령|검증 절차|check", "320|mobile|좁은|모바일", "1280|desktop|wide|넓은|데스크톱", "keyboard|focus|키보드|포커스", "reduced motion|prefers-reduced-motion|감속", "overflow|잘림|스크롤", "performance|inp|cls|성능", "measure|측정|계측", "accessib|aria|screen reader|접근성", "target|24|조작", "evidence|screenshot|스크린샷|증거", "pass|fail|통과|실패|expected|기대"),
}
