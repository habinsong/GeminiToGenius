...
- 형식: `100644`
- 바이트: 3146
- SHA-256: `f7dfc01e1dc09cf08fce5bc5bd039fc177a299fed738742253a4d5a1da9a0cbe`
- 인코딩: `utf-8`

````
# GeminiToGenius

> Gemini を少しでも賢く、安全にするための AI コーディング支援ハーネスです。
...
| UI/UX 品質基準 | ユーザー課題主導 & Zero AI Slop UI 検証 |
| ライフサイクルフック | 14 |
| 集中スキル | 11 |
| 外部プラグイン | なし |
...
- **プロダクト根拠に基づくUI**: 実際の製品要件とユーザー課題に根ざした画面設計を適用。
- **人間味のある丁寧な文章**: 非専門家でも直感的に理解できる自然な終止形（〜します、〜です）で記述。
