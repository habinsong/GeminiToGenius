...
- 형식: `100644`
- 바이트: 10956
- SHA-256: `6df48c030398b7f1adfc274aa0a23a440880681a5ac08a2e4ba08a4d106840b4`
- 인코딩: `utf-8`
...
`status`·`verify`·`checkpoint`는 작업 ID로 상태를 찾으며 `--workspace`를 받지 않습니다. 해당 작업공간에서 실행하거나 아래의 전역 `--state` 옵션을 사용합니다.
