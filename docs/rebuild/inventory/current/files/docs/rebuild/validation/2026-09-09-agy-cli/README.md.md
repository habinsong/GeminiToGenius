...
- 형식: `100644`
- 바이트: 7585
- SHA-256: `4aa26fc892a43954ab8b9e84f0cdea1c3e7bc8061f0a03807734d7629df8b646`
- 인코딩: `utf-8`
...
`agy plugin install <경로>`로 다시 가져오자 복구됐습니다. 사용자 환경은 원래 상태로 되돌려 두었습니다.

이 관찰은 한 번의 시험이며 `enable`의 의도된 의미를 확인하지 못했습니다. 다만 **끄고 켜는 것으로 원상 복구를 가정하지 말고 재등록으로 확인해야 한다**는 점은 기록해 둡니다.
