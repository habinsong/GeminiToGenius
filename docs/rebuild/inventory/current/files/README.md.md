...
- 형식: `100644`
- 바이트: 9950
- SHA-256: `d7466b15ac385e556e2dcaf790e0a3410f8ac02a97993a3d085873a684b87619`
- 인코딩: `utf-8`
...
검사를 실행할 때 어떤 Python 파일이 실제로 실행됐는지도 함께 기록합니다. 증명서의 `unverified_scope`에는 **통과했지만 어떤 검사도 실행하지 않은 검증 대상**이 나옵니다. 통과 자체가 근거의 전부가 아니라는 것을 사실로 보여 줍니다. 파일 단위 관찰이며 줄·분기 커버리지가 아닙니다. Python 실행을 관찰하지 못한 검사는 미실행을 주장하지 않습니다.
