...
- 형식: `100644`
- 바이트: 9174
- SHA-256: `058f2b1cf053bc313fdd7f7c471dcb053fed0f4bf45670351f14dfe56d5d78eb`
- 인코딩: `utf-8`
...
현재 버전은 **3.0.0-alpha.1 사전 릴리스**입니다. 기존 프롬프트 프로필을 Python 실행 코어·호스트별 훅·작업별 스킬로 재개발하고 있습니다. 로컬 실행과 Antigravity의 발견·초기 훅·자동 스킬 선택을 확인했으며, Gemini 3.8 Flash High로 선택된 단일 오류 수정 사례가 독립 검사를 통과했습니다. 다른 모델과 다양한 작업, 경쟁 도구 대비 품질은 아직 검증하지 않았습니다.
