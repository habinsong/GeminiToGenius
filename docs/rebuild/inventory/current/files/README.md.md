...
- 형식: `100644`
- 바이트: 9950
- SHA-256: `729276ebe1329ee750a2b1924e85fd4408673194a51e17f5f68ed02377a6fdf4`
- 인코딩: `utf-8`
...
발행된 최신 릴리스는 **3.0.0-alpha.1 사전 릴리스**이며 저장소의 현재 버전은 **3.0.0-alpha.2(개발 중, 미발행)**입니다. 기존 프롬프트 프로필을 Python 실행 코어·호스트별 훅·작업별 스킬로 재개발하고 있습니다. 로컬 실행과 Antigravity의 발견·초기 훅·자동 스킬 선택을 확인했으며, Gemini 3.8 Flash High로 선택된 단일 오류 수정 사례가 독립 검사를 통과했습니다. 다른 모델과 다양한 작업, 경쟁 도구 대비 품질은 아직 검증하지 않았습니다.
