...
- The v2.10.0 entrypoint is 5,982 characters: source-first routing, contiguous file intake, decision-ledger planning, recovery-path checks, and render-to-vision-to-web UI audit gates only.
