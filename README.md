...
- The v2.9.0 entrypoint is 5,944 characters: source-first routing, contiguous file intake, decision-ledger planning, recovery-path checks, and UI audit gates only.
